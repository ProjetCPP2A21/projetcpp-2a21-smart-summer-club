/********************************************************************************
** Form generated from reading UI file 'interface_formation.ui'
**
...
#ifndef UI_INTERFACE_FORMATION_H
#define UI_INTERFACE_FORMATION_H
...
"border-color: rgb(255, 255, 255);"));
        ...
        pushButtonAjouter->setGeometry(QRect(520, 120, 121, 41));
        pushButtonAjouter->setFont(font2);
        pushButtonAjouter->setStyleSheet(QString::fromUtf8("background-color: rgb(240, 195, 0);"));
        pushButtonsupprimer = new QPushButton(groupBox_3);
        pushButtonsupprimer->setObjectName("pushButtonsupprimer");
        pushButtonsupprimer->setGeometry(QRect(520, 190, 121, 41));
        pushButtonsupprimer->setFont(font2);
        pushButtonsupprimer->setStyleSheet(QString::fromUtf8("background-color: rgb(240, 195, 0);"));
        pushButtonSauvegarder = new QPushButton(groupBox_3);
        pushButtonSauvegarder->setObjectName("pushButtonSauvegarder");
        pushButtonSauvegarder->setGeometry(QRect(520, 260, 121, 41));
        pushButtonSauvegarder->setFont(font2);
        pushButtonSauvegarder->setStyleSheet(QString::fromUtf8("background-color: rgb(240, 195, 0);"));
        pushButtonModifier = new QPushButton(groupBox_3);
        pushButtonModifier->setObjectName("pushButtonModifier");
        pushButtonModifier->setGeometry(QRect(520, 330, 121, 41));
        pushButtonModifier->setFont(font2);
        pushButtonModifier->setStyleSheet(QString::fromUtf8("background-color: rgb(240, 195, 0);"));
        pushButtonTrier = new QPushButton(groupBox_3);
        pushButtonTrier->setObjectName("pushButtonTrier");
        pushButtonTrier->setGeometry(QRect(520, 400, 121, 41));
        pushButtonTrier->setFont(font2);
        pushButtonTrier->setStyleSheet(QString::fromUtf8("background-color: rgb(240, 195, 0);"));
...
"border-radius: 10px;"));
        ...
        label_9->setGeometry(QRect(30, 20, 151, 101));
...
#endif // UI_INTERFACE_FORMATION_H
