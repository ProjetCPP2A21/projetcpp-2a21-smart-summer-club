...
private slots:
    ...
    void on_pushbutton_verifBuzzer_clicked();
    void on_lineEdit_verifBuzzer_returnPressed();
    void on_lineEdit_verifBuzzer_textChanged(const QString &text);
...
private:
    ...
    /*-----karim----*/
    Arduino d;  // Arduino pour service_apprenant ET buzzer
    ...
    bool verifierEquipementParID(const QString &idEquipement);
    void envoyerCommandeBuzzer(const QString &commande);
