...
void interface_formateur::onTableSelectionChanged()
{
    ...
    if (!indexes.isEmpty()) {
        ...
        QString contact = ui->Tab_Formateur->model()->index(row, 4).data().toString();
        QString sexe = ui->Tab_Formateur->model()->index(row, 3).data().toString();//MODIF
...
void interface_formateur::on_pushButton_RechercheFormateur_clicked()
{
    ...
    if (test) {
       ...
       // QMessageBox::information(this, "valide", "Formateur trouve.");
