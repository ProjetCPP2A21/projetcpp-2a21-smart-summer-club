...
private slots:
    ...
    /*void verifierIdTFT(const QString &buffer);
    void afficherMessageTFT(const QString &msg);
    void lireBufferArduino();
    void afficherMessageQt(const QString &msg);*/
    //void update_label();     // Slot pour recevoir les données
    //void on_pushButtonEnvoyer_clicked(); bouton envoyer4
